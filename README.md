...
- [Founder Toolkit](https://github.com/mooster/founder-toolkit) by [Mu Chen](https://github.com/mooster) - 4 production skills for startup founders: investor update writer (YC/a16z format, EN/中文), pitch deck reviewer (10-dimension VC scoring rubric), SaaS metrics dashboard (ARR/NRR/LTV/CAC with benchmarks), and outreach lead scorer with email verification. Built from real operational experience running a $120B+ AUM fintech with 60+ institutional clients.
